        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-header">
                <ul class="sidebar-links">
                    ...
                    <br>
                    <li>
                        <a href="consultarTODOS.jsp" name="op" value="consultarTodos"><span class="material-symbols-outlined">
                                manage_search
        ...
        <div class="Wrapper">
            <div class="InputContainer">
                <form class="search-form" action="ControleLivro" method="GET"> 
                    <input id="input" class="entrada" name="txtTitulo" placeholder="Digite o título do livro" type="text">
