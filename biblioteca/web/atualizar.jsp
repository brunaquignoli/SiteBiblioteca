                ...
                <div class="container-linhas" style="display: flex;
                    ...
                    <div class="container-input">
                        <label style="
                               ...
                               display: flex;
                               align-items: center;
                               justify-content: center;" tabIndex="0">
                            <input type="file" id="imageInput" accept="image/*" name="txtcaminhoimagem" value="<%=L.getCaminhoImagem()%>"
                                   id="picture__input" style="display: none;"/> 
                            <span id="picture__image"> Faça upload da capa do livro </span>
                        </label>
                    </div>
